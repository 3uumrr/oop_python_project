...
class Vehicle(ABC): #abstract class
    def __init__(self, vehicle_name, vehicle_color, vehicle_year):
...
class Motorcycle(Vehicle):
    def __init__(self, vehicle_name, vehicle_color, vehicle_year,motocycle_price):
        Vehicle.__init__(self, vehicle_name, vehicle_color, vehicle_year)     #Inheritance
...
class Car(Vehicle):
    def __init__(self, vehicle_name, vehicle_color, vehicle_year, vehicle_max_speed):   #Inheritance
        Vehicle.__init__(self, vehicle_name, vehicle_color, vehicle_year)
        self.__vehicle_max_speed = vehicle_max_speed    #Privet Attribut
   
        #Setter And Getter
    def set_Speed(self, new_max_speed):
        self.__vehicle_max_speed = new_max_speed                                   
...
class Plane(Vehicle):
    def __init__(self, vehicle_name, vehicle_color, vehicle_year):
        Vehicle.__init__(self, vehicle_name,vehicle_color ,vehicle_year)                #Inheritance
        self.__vehicle_color =  vehicle_color      #Private Attribute
...
class Ship(Vehicle):
    def __init__(self, vehicle_name, vehicle_color, vehicle_year,vehicle_load):
        Vehicle.__init__(self, vehicle_name, vehicle_color, vehicle_year)           #Inheritance
        self.__vehicle_load = vehicle_load          #Private Attribute
